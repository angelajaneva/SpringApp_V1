...
//        comments.add(new Comment(2L, "The relational db model is based on a collection of tables. The user of the " +
...
//                "of db involves both the definition of structures for the storage of " +
...
//                "access. If db are to be shared among several users, the system must avoid " +
...
//                "rules and patterns from db. The field of db mining combines knowledge discovery " +
...
//                "disks, or other forms of RAID,which provide redundant db storage. Offline, " +
//                "or archival, stable storage may consist of multiple tape copies of db stored " +
...
//        comments.add(new Comment(23L, "Log records contain old values and new values for all updated db items. " +
...
//                "display results. They may also include a db access layer that implements " +
...
//                "the relational db model takes its name. In mathematical terminology, a tuple is " +
...
//                "various concepts underlying the relational db model. These relations represent " +
//                "part of a university. They do not include all the db an actual university database " +
